...
export default function Psi() {
  ...
  return (
    <section id="result">
      <GridContainer>
        <GridNormal>
          <h1 className="text-4xl">4. Results</h1>
          <h2 className="text-2xl">
            1. As unfairness in success grows, the kingdom is falling apart
          </h2>
          <PsiGini />
        ...
        <GridNormal>
          <h2 className="text-2xl">
            2. <i>sedoga</i> has seized success
          </h2>
          <PsiSedogaGwageo />
          <PsiSedogaPsi />
          <ul className="list-disc ml-5 space-y-2">
            <li className="text-base">
              ...
              best-known ones-that gained sway of the kingdom through successful
              marriages into the royal family.
            </li>
            <li className="text-base">
              The above plot shows the proportion of individuals from the sedoga
              who passed the Gwageo out of all those who did so in the past. As
              we approach the late Joseon period, their rate of passing the
              examination rapidly increases. This suggests that the Gwageo
              system is becoming corrupt.
            </li>
            <li className="text-base">
              The plot below illustrates the proportion of sedoga within the top
              10% of the ψ value. Similarly, we can see a significant increase
              in this proportion as we enter the 1800s.
            </li>
          </ul>
        </GridNormal>
        <GridNormal>
